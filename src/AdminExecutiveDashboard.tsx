    ...
    <div className="executive-layout">
      ...
      <div className="executive-content" id="admin-dashboard">
        ...
        <div className="executive-grid-two bottom-grid">
          ...
          <article className="executive-card smart-card"><div className="executive-card-title"><div><span>أدوات الإدارة</span><h2>أوامر سريعة</h2></div><span>تشغيل مباشر</span></div><div className="quick-actions">{canCustomers&&<a href="#admin-catalog">▦ الكتالوج والمنتجات</a>}{canCustomers&&<a href="#admin-product-create">＋ إضافة منتج</a>}{canOrders&&<a href="#admin-orders">▤ إدارة الطلبات</a>}{canCustomers&&<a href="#admin-customers">▣ إدارة العملاء</a>}{canInventory&&<a href="#admin-inventory">▥ إدارة المخزون</a>}{canFinance&&<a href="#admin-finance">◫ الحسابات والمالية</a>}{canInventory&&<a href="#admin-export">⇅ الاستيراد والتصدير</a>}{canAdmin&&<a href="#admin-settings">⚙ إعدادات التحكم</a>}</div><div className="credit-summary"><span>الائتمان المتاح</span><strong>{money(snapshot.availableCredit)}</strong></div></article>
        </div>
