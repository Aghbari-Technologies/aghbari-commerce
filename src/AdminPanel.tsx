...
export default function AdminPanel({ role }: { role: UserRole }) {
  ...
  return <section className="admin-panel staff-console" id="account">
    ...
    <details className="admin-operations" open>
      <summary><span><b>مركز التشغيل التفصيلي وإدارة البيانات</b><small>النماذج، الحالات، والعمليات الحساسة</small></span><em>يفتح مساحات التشغيل بالترتيب الإداري</em></summary>
