...
describe('calculateClientPreviewTotal', () => {
  ...
  it('does not return Infinity when a line multiplication overflows', () => expect(calculateClientPreviewTotal([{ product: productValue, quantity: Number.MAX_SAFE_INTEGER, unitPrice: Number.MAX_VALUE }, { product: productValue, quantity: 2, unitPrice: 3 }])).toBe(6));
