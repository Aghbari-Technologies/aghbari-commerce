-- Align the catalog RPC with the warehouse-aware application service boundary.
-- Keep the legacy 4-argument RPC for compatibility; expose the 5-argument variant explicitly.
