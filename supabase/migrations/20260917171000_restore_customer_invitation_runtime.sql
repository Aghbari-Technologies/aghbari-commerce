-- Restore the customer invitation runtime contract in environments whose migration ledger
-- advanced without creating the invitation objects. Additive and forward-safe: existing
-- deployments keep their data; existing signatures and grants are preserved.
