...
create unique index if not exists branches_id_org_uidx
  on public.branches(id, organization_id);

create unique index if not exists categories_id_org_uidx
  on public.categories(id, organization_id);

create unique index if not exists products_id_org_uidx
  on public.products(id, organization_id);

create unique index if not exists customers_id_org_uidx
  on public.customers(id, organization_id);

create unique index if not exists price_lists_id_org_uidx
  on public.price_lists(id, organization_id);

create unique index if not exists carts_id_org_uidx
  on public.carts(id, organization_id);

create unique index if not exists orders_id_org_uidx
