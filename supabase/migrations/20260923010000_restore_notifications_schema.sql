...
-- Restore the notification contract required by order creation and the customer portal.
-- The live schema includes recipient_user_id; it remains nullable and intentionally has
-- no FK because notification recipients may be customer-scoped without a profile row.
