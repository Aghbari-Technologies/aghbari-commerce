...
-- Storage object UPDATE remains denied through direct SQL; supported media replacement
-- must use the Storage API, while server registration remains the canonical DB mutation.
