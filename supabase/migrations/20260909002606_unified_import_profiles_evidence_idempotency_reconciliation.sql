...
GRANT EXECUTE ON FUNCTION public.create_intelligence_evidence(text,text,text,text,jsonb,text,jsonb,jsonb,numeric,timestamptz,timestamptz) TO authenticated;
