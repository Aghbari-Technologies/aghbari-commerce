...
-- Customer-owned data is scoped to the authenticated profile.customer_id.
...
-- Customers only read their own pricing/financial records; templates are customer-owned.
