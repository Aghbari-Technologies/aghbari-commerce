-- Storage-only authorization context helpers.
-- Keep Storage RLS independent from profiles RLS and make the auth/profile lookup
-- explicit for SECURITY DEFINER execution.
...
REVOKE EXECUTE ON FUNCTION public.storage_current_organization_id() FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.storage_is_staff() FROM PUBLIC;
