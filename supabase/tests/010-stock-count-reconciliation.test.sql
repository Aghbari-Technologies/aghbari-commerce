...
select throws_ok($$select public.start_stock_count('67676767-6767-4676-8676-676767676771','stock-count-idem-02')$$,'55006',null,'A second open stock count for another warehouse is still blocked by the tenant active-count rule');
