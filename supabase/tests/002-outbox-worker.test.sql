...
values
  ('cccccccc-cccc-4ccc-8ccc-cccccccccc11','cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'order', 'cccccccc-cccc-4ccc-8ccc-cccccccccc11', 'order.created', '{"kind":"tenant-a"}'::jsonb),
  ('dddddddd-dddd-4ddd-8ddd-dddddddddd11','dddddddd-dddd-4ddd-8ddd-dddddddddddd', 'order', 'dddddddd-dddd-4ddd-8ddd-dddddddddd11', 'order.created', '{"kind":"tenant-b"}'::jsonb);
...
values ('cccccccc-cccc-4ccc-8ccc-cccccccccc12','cccccccc-cccc-4ccc-8ccc-cccccccccccc', 'order', 'cccccccc-cccc-4ccc-8ccc-cccccccccc12', 'order.created', '{}'::jsonb, 'processing', 1, now() - interval '1 minute');
