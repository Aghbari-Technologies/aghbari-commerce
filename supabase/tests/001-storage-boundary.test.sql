...
select throws_ok($$select public.register_product_media('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbb1'::uuid,'bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb/bbbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbb1.webp','image/webp',1200,900,2048)$$,'42501',null,'Server rejects a product from another tenant');
