...
create temp table storage_update_probe(updated_rows integer);
DO $$
declare n integer;
begin
  update storage.objects
     set name='aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa/aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaa11/aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaa34.webp'
  ...
  insert into storage_update_probe values(n);
END $$;
select is((select updated_rows from storage_update_probe limit 1),0,'Direct storage object UPDATE is not an application capability');
