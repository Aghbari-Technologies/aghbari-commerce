...
insert into public.products(id,organization_id,sku,name,unit,status) values
 ...
 ('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb011','bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb','B-1','Product B','كرتون','active');
...
insert into storage.objects(bucket_id,name,owner_id,metadata) values
 ...
 ('product-media','bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb/bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb011/bbbbbbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb021.webp','22222222-2222-4222-8222-222222222222','{"mimetype":"image/webp","size":1024}'::jsonb),
...
select throws_ok($$select public.register_product_media('bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb011'::uuid,'bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb/bbbbbbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbb021.webp','image/webp',1200,900,2048)$$,'42501',null,'Server rejects a product from another tenant');
