...
insert into public.order_items(organization_id,order_id,product_id,quantity,unit_price,line_total)
select org_a,order_a,product_a,2,5,10 from fixture union all select org_b,order_b,product_b,2,10,20 from fixture;
