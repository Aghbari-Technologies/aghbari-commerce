...
select order_a,org_a,customer_a,warehouse_a,900001,'pending','YER',10,10,'order-a-key-123456',admin_a from fixture union all select order_b,org_b,customer_b,warehouse_b,900002,'pending','YER',20,20,'order-b-key-123456',admin_b from fixture;
