...
select org_a,order_a,product_a,2,5,'wholesale'::customer_tier from fixture union all select org_b,order_b,product_b,2,10,'wholesale'::customer_tier from fixture;
