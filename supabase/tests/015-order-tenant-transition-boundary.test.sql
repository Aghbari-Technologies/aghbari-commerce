...
select customer_a,org_a,'Order Customer A','wholesale'::public.customer_tier,true from fixture union all select customer_b,org_b,'Order Customer B','wholesale'::public.customer_tier,true from fixture;
insert into public.profiles(id,organization_id,customer_id,role)
select admin_a,org_a,customer_a,'admin'::user_role from fixture union all select admin_b,org_b,customer_b,'admin'::user_role from fixture union all select viewer_a,org_a,customer_a,'viewer'::user_role from fixture;
