...
select is((select public.commit_product_import(public.stage_product_import('two.xlsx','bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb','[{"sku":"DELTA-TEST","name":"Delta Test","unit":"unit","category":"Delta","quantity":7,"prices":{"retail":10,"wholesale":9,"distributor":8}}]'::jsonb),(select warehouse_id from fixture))).inventory_changed,1,'Second import records one inventory change');
