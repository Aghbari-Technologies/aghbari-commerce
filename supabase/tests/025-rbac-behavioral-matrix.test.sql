...
set local request.jwt.claim.sub='aaaaaaaa-aaaa-4bbb-8bbb-aaaaaaaa0003';
...
select is(public.set_organization_user_role('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaa0005','viewer'),'viewer'::public.user_role,'owner can restore a role fixture after assignment proof');
set local request.jwt.claim.sub='aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaa0002';
...
set local request.jwt.claim.sub='bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbb0001';
select throws_ok($$select public.set_organization_user_role('aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaa0005','admin')$$,'42501',null,'foreign tenant admin cannot assign Tenant A roles');
...
set local request.jwt.claim.sub='aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaa0005';
select throws_ok($$update public.client_ui_settings set config='{"showSearch":true}'::jsonb where organization_id='aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaa0100'$$,'42501',null,'viewer cannot update settings');
set local request.jwt.claim.sub='aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaa0006';
...
set local request.jwt.claim.sub='bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbb0001';
select is((select config->>'showSearch' from public.client_ui_settings where organization_id='aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaa0100'),'false','foreign admin cannot alter Tenant A settings');

set local request.jwt.claim.sub='aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaa0001';
select lives_ok($$select public.request_reporting_export('orders','role-owner','1.0','rbac-role-owner-key-001')$$,'owner can request reporting export');
set local request.jwt.claim.sub='aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaa0002';
select lives_ok($$select public.request_reporting_export('orders','role-admin','1.0','rbac-role-admin-key-001')$$,'admin can request reporting export');
set local request.jwt.claim.sub='aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaa0003';
select throws_ok($$select public.request_reporting_export('orders','role-sales','1.0','rbac-role-sales-key-001')$$,'42501',null,'sales cannot request reporting export');
set local request.jwt.claim.sub='aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaa0004';
select throws_ok($$select public.request_reporting_export('orders','role-warehouse','1.0','rbac-role-warehouse-key-001')$$,'42501',null,'warehouse cannot request reporting export');
set local request.jwt.claim.sub='aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaa0005';
select throws_ok($$select public.request_reporting_export('orders','role-viewer','1.0','rbac-role-viewer-key-001')$$,'42501',null,'viewer cannot request reporting export');
set local request.jwt.claim.sub='aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaa0006';
select throws_ok($$select public.request_reporting_export('orders','role-customer','1.0','rbac-role-customer-key-001')$$,'42501',null,'customer cannot request reporting export');
