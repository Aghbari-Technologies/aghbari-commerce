...
select customer_a,org_a,'Customer A','wholesale'::customer_tier,true from fixture union all select customer_b,org_b,'Customer B','wholesale'::customer_tier,true from fixture;
