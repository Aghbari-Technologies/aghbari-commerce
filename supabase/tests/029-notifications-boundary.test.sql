begin;
select plan(6);
insert into auth.users(id,email) values ('41414141-4141-4141-8141-414141414141','notification-customer-a@test.local'),('42424242-4242-4242-8242-424242424242','notification-customer-b@test.local');
insert into public.organizations(id,name,is_active) values ('43434343-4343-4343-8343-434343434343','Notification Tenant A',true),('44444444-4444-4444-8444-444444444444','Notification Tenant B',true);
insert into public.customers(id,organization_id,name,tier,is_active) values ('45454545-4545-4545-8545-454545454545','43434343-4343-4343-8343-434343434343','Notification Customer A','retail',true),('46464646-4646-4646-8646-464646464646','44444444-4444-4444-8444-444444444444','Notification Customer B','retail',true);
insert into public.profiles(id,organization_id,customer_id,role) values ('41414141-4141-4141-8141-414141414141','43434343-4343-4343-8343-434343434343','45454545-4545-4545-8545-454545454545','viewer'),('42424242-4242-4242-8242-424242424242','44444444-4444-4444-8444-444444444444','46464646-4646-4646-8646-464646464646','viewer');
