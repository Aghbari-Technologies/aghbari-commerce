...
select public.stage_product_import('tenant-a.xlsx',repeat('a',64),'[{"sku":"IMP-A","name":"Imported A","unit":"unit","category":"Imported","quantity":4,"prices":{"retail":10,"wholesale":9,"distributor":8}}]'::jsonb) is not null;
